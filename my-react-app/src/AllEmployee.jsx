...
function AllEmployee() {
  ...
  const filteredEmployees = employees.filter(emp => {
    ...
    const matchesSearch = empName.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         ...
                         empId.toString().toLowerCase().includes(searchTerm.toLowerCase());
              ...
              <tbody>
                {loading ? (
                  ...
                  filteredEmployees.map(employee => {
                    // Handle different field name possibilities
                    const empId = employee.empId || employee.employeeId || employee.id;
                    const empName = employee.employeeName || employee.name || 'N/A';
                    const empContact = employee.contactNumber || employee.contact || 'N/A';
                    const joinDate = employee.joinDate || employee.joiningDate;
                    
                    return (
                      <tr key={employee.id || empId}>
                        <td className="fw-bold">{empId}</td>
                        <td>{empName}</td>
                        <td>{employee.email || 'N/A'}</td>
                        <td>
                          <span className="badge bg-primary">{employee.department || 'N/A'}</span>
                        </td>
                        ...
                        <td>
                          <div className="btn-group" role="group">
                            <button
                              ...
                              onClick={() => handleEdit(employee.id || empId)}
                              title="Edit Employee"
                            >
                            ...
                            <button
                              ...
                              onClick={() => handleDelete(employee.id || empId)}
