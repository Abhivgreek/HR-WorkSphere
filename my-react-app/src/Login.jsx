...
function Login({ onLogin }) {
  ...
  return (
    <div>
      ...
      {/* Login Form Content */}
      <div className="container-fluid" style={{ minHeight: 'calc(100vh - 200px)', backgroundColor: '#f8f9fa', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: '2rem', paddingBottom: '2rem' }}>
